...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($koneksi, "
        INSERT INTO produk 
        (nama_produk, img, deskripsi, tutorial, is_popular)
        VALUES 
        ('$nama_produk', '$img', '$deskripsi', '$tutorial', '$is_popular')
    ");
...
<div class="card p-4" style="width:520px" data-aos="zoom-in">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea name="tutorial" class="form-control" rows="4"></textarea>
        </div>

        <div class="mb-3 form-check">
            <input type="checkbox" name="is_popular" class="form-check-input">
            <label class="form-check-label">Produk Populer</label>
        </div>
    ...
    <div class="text-center">
        <a href="produk.php" style="color:var(--merah); font-weight:600;">← Kembali ke Data Produk</a>
    </div>
</div>
